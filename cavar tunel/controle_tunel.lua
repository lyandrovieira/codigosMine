...
while true do
    ...
    while true do
        ...
        if resp == "a" then --FEITO - Permite alterar a quantidade de blocos escavados após a primeira execução do código.
        ...
        if resp == "c" then --FEITO - Encerra o processo de escavação de túneis.
